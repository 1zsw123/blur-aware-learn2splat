...
class Combined_Geo_Encoding_Volume:
    def __init__(self, init_fmap1, init_fmap2, geo_volume, num_levels=2, dx=None, no_corr=False):
    ...
    def __call__(self, disp, coords, low_memory=False, no_geo_volume=False):
        b, _, h, w = disp.shape
