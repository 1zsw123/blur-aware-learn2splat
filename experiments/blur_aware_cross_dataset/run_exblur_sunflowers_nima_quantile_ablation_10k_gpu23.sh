...
CONFIG="$BASE/outputs/logs/exblur_sunflowers_nima_quantile_ablation_s1/scenes.json"
OUTPUT_ROOT="$BASE/outputs/learn2splat_legs_blur_evssm_exblur_sunflowers_nima_quantile_10k_s1"
LOG_ROOT="$BASE/outputs/logs/learn2splat_legs_blur_evssm_exblur_sunflowers_nima_quantile_10k_s1"

GPU2_SCENES=(exblur_sunflowers_nimatop25 exblur_sunflowers_nimatop15)
GPU3_SCENES=(exblur_sunflowers_nimatop20 exblur_sunflowers_nimatop10)
